...
--Colocando dodos
--Categorias
insert into CriptoCategorias values(1, 'Simples'  , 'Criptografias mais fáceis de entender, compostas de algoritmos de poucas etapas','C')
insert into CriptoCategorias values(2, 'Complexas', 'Criptografias mais complexas de entender, compostas de algoritmos de várias etapas','B')
insert into CriptoCategorias values(3, 'Mistas'   , 'Criptografias que são compostas por outras criptografias e misturadas com outros algoritmos','A')
...
insert into Criptografia values(2,'Cifra de César','Esta é uma das mais antigas e mais simples forma de criptografia existente.','A Cifra de César consiste basicamente em um processo de substituição com base em um número que indica quantas posições o alfabeto original
...
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/Caesar3.svg/640px-Caesar3.svg.png">',1,2)
...
insert into Criptografia values(4,'Binário','Essa é uma forma de criptografia na qual se substitui a base de um número decimal de 10 para 2','Nâo é muito usada como criptografia, já que é, de certa forma, uma línguagem que os computadores 
...
Depois disso, você terá de juntar todos os restos e ordená-los de trás pra frente. Para um exemplo em vídeo, <a href="https://www.youtube.com/watch?v=mttrG_kbHN4" target="_blank">Clique aqui.</a>
<img src="https://3.bp.blogspot.com/-cANHx4dx_LA/TdZsKqAUvqI/AAAAAAAAAV8/E5xQCFws5rY/s1600/decimal+para+bin%25C3%25A1rio.jpg">
<p><b>Dica:</b></p> Para converter letras para binário, pesquise sobre a <a href="https://pt.wikipedia.org/wiki/ASCII" target="_blank">Tabela ASCII</a>',
3,2)
