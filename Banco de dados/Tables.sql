...
insert into Criptografia values(2,'Cifra de César','A Cifra de César consiste basicamente em um processo de substituição com base em um número que indica quantas posições o alfabeto original
...
insert into Criptografia values(4,'Binário','Nâo é muito usada como criptografia, já que é, de certa forma, uma línguagem que os computadores 
